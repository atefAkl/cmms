...
<aside
    ...
    <div class="p-4 border-t border-white/5 bg-gray-950/20">
        <div class="flex items-center justify-between px-2 py-2">
            ...
            <a href="{{ route('settings.index') }}" class="p-1.5 rounded-md hover:bg-gray-800 {{ Route::is('settings.*') ? 'text-indigo-500 bg-gray-950/40' : 'text-gray-500' }} hover:text-white transition">
