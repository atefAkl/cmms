                ...
                <form method="POST" action="{{ route('rooms.store') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="target_temperature" class="block mt-1 w-full" type="number" step="0.1"
                                name="target_temperature" :value="old('target_temperature')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="min_temperature" class="block mt-1 w-full" type="number" step="0.1"
                                name="min_temperature" :value="old('min_temperature')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="max_temperature" class="block mt-1 w-full" type="number" step="0.1"
                                name="max_temperature" :value="old('max_temperature')" required />
