                    ...
                    <form method="POST" action="{{ route('inventory.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="part_number" class="block mt-1 w-full" type="text" name="part_number" :value="old('part_number')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="min_stock_level" class="block mt-1 w-full" type="number" name="min_stock_level" :value="old('min_stock_level', 5)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="cost" class="block mt-1 w-full" type="number" step="0.01" name="cost" :value="old('cost')" required />
